...
<div class="row justify-content-center">
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="<?= Config::getBaseUrl() ?>backend/controllers/auth_controller.php">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" autocomplete="username-or-email" required>
          </div>
          <div class="mb-3">
